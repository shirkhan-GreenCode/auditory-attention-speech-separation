function [labels, runningCenters] = cluster_framewise_previous(features, K, strictPresence)
%CLUSTER_FRAMEWISE_PREVIOUS Frame-wise clustering using previous centers as reference.
arguments
    features double
...
for i = 2:frames
    ...
    [mappedLabels, runningCenters] = map_and_update(curLabels, curCenters, runningCenters, false, strictPresence);

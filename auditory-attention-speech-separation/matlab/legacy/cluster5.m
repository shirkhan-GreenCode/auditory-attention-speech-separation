function [cl,Ctotal]=cluster5(rave,K);
% anjame clusterin be ravesh panjom (clustering har fram).ravesh 
% estefade az marakeze frame ghabl va   vojoode do gooiande dar har fram
[m,n]=size (rave);
cl_total=zeros(m,1);
